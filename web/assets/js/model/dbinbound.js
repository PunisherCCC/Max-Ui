class DBInbound {
    ...
    // Deprecated compatibility field. Bandwidth multiplier now applies from byte zero;
    // the backend always writes this value as 0, and new forms no longer bind it.
