...
// XUIController is the main controller for the max-ui panel, managing sub-controllers.
...
func (a *XUIController) index(c *gin.Context) {
	...
	// The donate dialog on the MAX-UI tile. Rendered server-side rather than
