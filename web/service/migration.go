...
// max-ui's schema is a strict superset of stock 3x-ui, and InitDB already carries
...
// After importing a max-ui backup that carries them, the ranges are re-normalized
...
// ImportForeignDB replaces the current database with an uploaded 3x-ui (or max-ui)
