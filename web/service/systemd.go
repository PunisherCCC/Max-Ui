...
// character so the name can't escape /etc/systemd/system. Falls back to "max-ui".
...
// GetServiceName returns the configured panel service name (default "max-ui").
