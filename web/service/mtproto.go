...
func (s *MtprotoService) configDir(inboundId int) string {
	return fmt.Sprintf("/etc/max-ui-mtproto/server-%d", inboundId)
}
...
func (s *MtprotoService) buildServerConfig(inbound *model.Inbound, settings *mtprotoSettings) string {
	...
	b.WriteString("# Auto-generated by max-ui (MTProto Proxy). Do not edit.\n")
	...
	// Per-account mode enforcement (max-ui patch, see build/backend/telemt-patches).
