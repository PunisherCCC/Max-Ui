...
// supportedDistros is the hard-coded list of distros max-ui is actually tested on
...
// DistroSupported reports whether the running host is on max-ui's tested distro
