...
var coreCatalog = []coreSpec{
	...
	},
	{
		...
		paths: []string{"/etc/max-ui-sstp"},
		globs: []string{"/etc/max-ui-sstp/server-*"},
	},
	{
		...
		// /etc/max-ui-ikev2 is deliberately NOT here. Despite the name it is the
	...
	},
	{
		...
		paths: []string{"/etc/max-ui-mtproto"},
		globs: []string{"/etc/max-ui-mtproto/server-*"},
	},
	{
		name: "ssh", title: "SSH", backend: "Built-in (max-ui)",
	...
	{
		name: "sing-box", title: "Sing-box", backend: "Sing-box",
		desc: "Alternative data-plane core, started from the Sing-box template", builtin: true,
	},
	{
		name: "radius", title: "RADIUS", backend: "Built-in (max-ui)",
