// Package web provides the main web server implementation for the max-ui panel,
...
// Server represents the main web server for the max-ui panel with controllers, services, and scheduled jobs.
type Server struct {
...
func (s *Server) initRouter() (*gin.Engine, error) {
	...
	engine.Use(sessions.Sessions("max-ui", store))
...
func (s *Server) Start() (err error) {
	...
	fmt.Printf("\nmax-ui panel listening on %s://%s:%d%s\n\n", scheme, hostDisp, port, basePath)
