...
> ? ??????? ?? ???? ????????? ??????????, AmneziaWG ?? ?????? ? ???? ?? ?????? ????????????: ?????? ???? ???????? ??? ?????? ???? ?? ????? ??????? ?? ????? ?????????????? ?????????. ?????? ???? ?????? ?? ?????????? ? ???? ???????. ?? **???? 7.1 ? ?????** (Fedora 43/44, Arch) ?? ???? ?????? ?????? `ipv6_stub`, ??????? ?????? ??-???????? ??????????. ?? **AlmaLinux, Rocky Linux ? CentOS Stream** ???????????????? ???? RHEL ??????????? ?? ????? ????????????? ??????, ? EL10 ?? ?? ?????????? ?????. ? ?? ? ?????? ???????? ???????????? ?????? ?????? AmneziaWG, ??????????? ??? ??? ??? ??? ?? ??????? ? ???????? ???????, ??????? ?????? ?? ??????????? ?????? ??????????.
> ????????? ???????????? ??? ? ???????? ???, ?????? ???? ????? ????? ??????????? ? ???????. **??? ????????? ????????? ????????? ???????? ?? ???? ???????????????? ???????????? ????????.**
...
WireGuard (C), AmneziaWG ? ?????? **PSK** / **EAP-TLS** ????????? IKEv2 ????????????????? ?? ????????? ????? ??? ???????????, ??????? ?? ????????? ????? ? RADIUS ? ????? ?? ???????? ?? ?? ?????? ? ??????, ?? ????? ???????, ?? ?????????? **User Limit**. **RBridge** (Radius Bridge) ????????? ???? ??????: ??? ?? ?????? ???? ????? ??????? ??? **Sweeper** ?????????? (poll) ???????? ??????? ??????? ?????????, ????????? ????? (quota), ?????????? ? **User Limit** K ??? ??????? ???????? (???????? ?????? ????? evict), ? ????? ?????? ???????? ? ??? ?? ?????????? ?????? ?????? **RADIUS** ? ??? ?? ???? ?? **nftables**, ??????? ??? ?????????? RADIUS-?????????. ? ????? ???????? ?? ?????? ?????? ????? ???? ????? ??? ?? ?? ???????, ????? ? ?????? ????????? ? ??????? ? ???????? ????? ??? ?? data plane **dokodemo-door** ? Xray.

??? ???? ?????????? ?????????? ?? ?????? ??????, **WireGuard (C)** ? **AmneziaWG**, ???????? K ? **User Limit** ???????? ??????? ???????? K ?????? ??? ??????????: K ??? ??????, K ???????? ? K ????????? ?????????? IP, ?? ?????? ??????? ?? ??????????. ??? ?? ?? ??????, ??? ?????????? ???????????? ???????, ? ?????? ??? ????????? ?????? ???????? ???????????? ???????? ?? ????????, ???????? ? ???????, ? ??????????? ?? ???????? ?? ???? ????.
