...
const (
	...
	StrongswanBundleRoot = "/usr/libexec/max-ui-strongswan" // must equal the bundle build PREFIX
...
// root (its entries are rooted at usr/libexec/max-ui-strongswan). Idempotent; no-op
