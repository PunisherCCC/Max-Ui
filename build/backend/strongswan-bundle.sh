...
PREFIX=/usr/libexec/max-ui-strongswan   # must equal backend.StrongswanBundleRoot
...
#!/bin/sh
# max-ui bundled charon launcher — do not edit (generated by strongswan-bundle.sh).
B=$PREFIX
...
#!/bin/sh
# max-ui bundled swanctl launcher — do not edit (generated by strongswan-bundle.sh).
B=$PREFIX
export LD_LIBRARY_PATH="\$B/lib:\$B/lib/ipsec:\${LD_LIBRARY_PATH:-}"
...
#!/bin/sh
# max-ui bundled pki launcher — do not edit (generated by strongswan-bundle.sh).
B=$PREFIX
export LD_LIBRARY_PATH="\$B/lib:\$B/lib/ipsec:\${LD_LIBRARY_PATH:-}"
export OPENSSL_MODULES="\${OPENSSL_MODULES:-\$B/lib/ossl-modules}"
...
# /usr/libexec/max-ui-strongswan exactly.
mkdir -p /out
