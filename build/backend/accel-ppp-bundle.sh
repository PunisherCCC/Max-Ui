...
#       path=/usr/libexec/max-ui-accel/lib/accel-ppp
...
PREFIX=/usr/libexec/max-ui-accel   # must equal backend.AccelBundleRoot
...
#!/bin/sh
# max-ui bundled accel-pppd launcher — do not edit (generated by accel-ppp-bundle.sh).
B=$PREFIX
...
#!/bin/sh
# max-ui bundled accel-cmd launcher — do not edit (generated by accel-ppp-bundle.sh).
B=$PREFIX
